...
def get_distance(f,spacing):
    ...
    """The signed distance map measures the distance from each point in the image to the nearest boundary, with the sign indicating whether the point is inside or outside the boundary."""
...
def get_head(img_path):
    """Helpful  for understanding spatial properties of medical images"""
    temp = stk.ReadImage(img_path)
