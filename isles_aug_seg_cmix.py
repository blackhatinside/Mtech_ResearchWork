...
def main():
	...
	case_ids = get_case_ids(INPUT_PATH)	# Original dataset
	aug_case_ids = get_case_ids(AUG_INPUT_PATH) if os.path.exists(AUG_INPUT_PATH) else [] # Augmented dataset
	...
	train_gen = DataGenerator(train_ids, aug_ids=aug_case_ids)	# Combines both datasets for training
